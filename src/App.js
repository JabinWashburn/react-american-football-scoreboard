  ...
  <div className="away__score">{awayScore}</div>
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick={homePts} className="homeButtons__touchdown">Home Touchdown</button>
          <button onClick={homeFG} className="homeButtons__fieldGoal">Home Field Goal</button>
        </div>
        <div className="awayButtons">
          <button onClick={awayPts}className="awayButtons__touchdown">Away Touchdown</button>
